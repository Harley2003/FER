  ...
  return (
    <Row style={{ display: "block" }}>
      <Col className="offset-lg-3 col-lg-6">
        ...
        <div className="text-center">
          <h6 className="lg-2 " style={{ fontWeight: "bold" }}>
            The social constructive learning tool
          </h6>
          <h5
            className="lg-2 "
            style={{ fontSize: "1.5em", color: "red", fontWeight: "bold" }}
          >
            University system (FU)
          </h5>
        </div>
        <br />
        <br />
          ...
          <ul className="contact-menu none-list">
            <li>
              ...
              >
                <button
                  style={{ color: "blue" }}
                  className="MuiButtonBase-root MuiButton-root MuiButton-text MuiButton-textPrimary MuiButton-sizeMedium MuiButton-textSizeMedium MuiButton-colorPrimary MuiButton-root MuiButton-text MuiButton-textPrimary MuiButton-sizeMedium MuiButton-textSizeMedium MuiButton-colorPrimary edu-button   css-nk4ijk"
                  type="button"
                >
              ...
              >
                ...
                >
                  <div>
                    ...
                    <span
                      style={{ color: "blue" }}
                      title=" - PHONE: +84 913677744"
                      value=" - PHONE: +84 913677744"
                    >
                      - PHONE: +84 913677744
                    </span>
                  </div>
