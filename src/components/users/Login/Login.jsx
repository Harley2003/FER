...
import image1 from '/Users/HOAN DO/Downloads/edunext/edunext/src/assets/images/logo-home-Djb_K2V0.png'
import '/Users/HOAN DO/Downloads/edunext/edunext/src/assets/css/loginstyle.css'
...
function Login() {
  ...
  const ProceedLogin = (values) => {
    ...
    if (validate()) {
        setLoading(true);
        try {
            const foundAccount = accounts.find(a => a.name == username);
            if (!foundAccount) {
